...
for name in cdk cdk-cln-cell cdk-bdk cdk-lnd-bdk cdk-postgres-cell cdk-ldk cdk-grpc-processor; do
...
[[ $(grep -c '^CALL$' "$CONFIG_TRACE") == 8 ]]
[[ $(grep -c '<ghcr.io/orangeshyguy21/proofstorm/cdk' "$CONFIG_TRACE") == 8 ]]
