...
lab = {
    ...
    "components": [
        ...
        {"id": "nutshell-mint", "kind": "mint", "implementation": "nutshell", "version": "0.20.2", "config_version": "nutshell-mint/0.20/v1", "control": "target", "config": {"name": "Proofstorm Nutshell Cross-Parity", "description": "Cross-implementation wallet acceptance"}},
...
print(json.dumps({"revision": published["digest"], "bootstrap_action": accepted_bootstrap["resource_name"], "implementations": results, "status": status}, indent=2))
