...
pub use adapter::{
    ...
    render_protocol_prober, render_wallet_component,
};
pub use api::{
...
pub use operation::{
    ...
    ChannelOpenJobSpec, ChannelRebalanceJobSpec, LightningAdapter, PeerConnectJobSpec,
    PeerDisconnectJobSpec, WalletFundJobSpec, WalletInvoiceJobSpec, WalletJobSpec,
