...
pub use operation::{
    ...
    ChannelCloseJobSpec, ChannelOpenJobSpec, ChannelRebalanceJobSpec, LightningAdapter,
    PeerConnectJobSpec, PeerDisconnectJobSpec, WalletFundJobSpec, WalletInvoiceJobSpec,
    WalletJobSpec, WalletPayJobSpec, WalletRoundTripJobSpec, action_result_container,
    evaluate_action_admission, render_authentication_conformance_job,
    render_authentication_protected_spend_job, render_authentication_replay_job,
    render_bootstrap_job, render_channel_close_job, render_channel_open_job,
    render_channel_rebalance_job, render_conservation_oracle_job, render_lab_action_cleanup_job,
    render_lab_action_job, render_peer_connect_job, render_peer_disconnect_job,
    render_wallet_balance_job, render_wallet_fund_job, render_wallet_initialize_job,
    render_wallet_invoice_job, render_wallet_pay_job, render_wallet_round_trip_job,
};
pub use render::{
