...
pub fn tool_title(name: &str) -> Option<&'static str> {
    Some(match name {
        ...
        "cell_clone" => "Clone cell",
        "cell_validate" => "Validate cell",
        "cell_diff" => "Compare cell configurations",
        "cell_publish" => "Publish cell configuration",
        "cell_materialize" => "Deploy cell",
        "cell_status" => "Check cell status",
        "cell_component_status_list" => "List component statuses",
        "cell_inventory_list" => "List cell resources",
        "cell_wait" => "Wait for cell",
        "cell_close" => "Close cell",
        ...
        "cell_recipe_bootstrap" => "Initialize recipe cell",
        "cell_recipe_route_channel_open" => "Open recipe route channels",
        "cell_recipe_fee_matrix_run" => "Run fee matrix",
